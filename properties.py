...
class Properties:
    def __init__(self):
        load_dotenv(
            dotenv_path=os.path.join(os.path.join(os.getcwd(), ".credentials"), ".env")
        )
        ...
        self.new_event_filter = {
            "filter": {"property": "gcal_id", "rich_text": {"is_empty": True}}
        }
        self.update_event_filter = {
            "filter": {"property": "Action", "select": {"equals": "Update"}}
        }
        self.delete_event_filter = {
            "filter": {"property": "Action", "select": {"equals": "Delete"}}
        }
        ...
        self.db_title = [
            {"type": "text", "text": {"content": self.db_name, "link": None}}
        ]
        self.db_properties = {
            "Title": {"title": {}},
            ...
            "Frequency": {
                ...
                "select": {
                    "options": [
                        ...
                        {"name": "SECONDLY", "color": "pink"},
                        {"name": "HOURLY", "color": "gray"},
                        {"name": "MINUTELY", "color": "green"},
            ...
            "By Month": {"number": {}},
            "Minutes before Email Reminder": {"number": {}},
            "Minutes before Popup Reminder": {"number": {}},
            "notion_id": {"rich_text": {}},
            "gcal_id": {"rich_text": {}},
            "Task Category": {
                "type": "select",
